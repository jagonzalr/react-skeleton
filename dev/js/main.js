...
var ingredients = [{ "id": 1, "text": "The Revenant" }, { "id": 2, "text": "Mad Max" }, { "id": 3, "text": "Spotlight" }];
...
ReactDOM.render(React.createElement(List, null), document.getElementById('movies'));
